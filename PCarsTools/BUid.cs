			...
			if (len <= 23)
			{
				while (len > 0)
				{
					...
					{              // all the case statements fall through
						case 23: c += ((ulong)k[len_x + 22] << 56);
							break;
						case 22: c += ((ulong)k[len_x + 21] << 48);
							break;
						case 21: c += ((ulong)k[len_x + 20] << 40);
							break;
						case 20: c += ((ulong)k[len_x + 19] << 32);
							break;
						case 19: c += ((ulong)k[len_x + 18] << 24);
							break;
						case 18: c += ((ulong)k[len_x + 17] << 16);
							break;
						case 17: c += ((ulong)k[len_x + 16] << 8);
							break;
						/* the first byte of c is reserved for the length */
						case 16: b += ((ulong)k[len_x + 15] << 56);
							break;
						case 15: b += ((ulong)k[len_x + 14] << 48);
							break;
						case 14: b += ((ulong)k[len_x + 13] << 40);
							break;
						case 13: b += ((ulong)k[len_x + 12] << 32);
							break;
						case 12: b += ((ulong)k[len_x + 11] << 24);
							break;
						case 11: b += ((ulong)k[len_x + 10] << 16);
							break;
						case 10: b += ((ulong)k[len_x + 9] << 8);
							break;
						case 9: b += ((ulong)k[len_x + 8]);
							break;
						case 8: a += ((ulong)k[len_x + 7] << 56);
							break;
						case 7: a += ((ulong)k[len_x + 6] << 48);
							break;
						case 6: a += ((ulong)k[len_x + 5] << 40);
							break;
						case 5: a += ((ulong)k[len_x + 4] << 32);
							break;
						case 4: a += ((ulong)k[len_x + 3] << 24);
							break;
						case 3: a += ((ulong)k[len_x + 2] << 16);
							break;
						case 2: a += ((ulong)k[len_x + 1] << 8);
							break;
						case 1: a += ((ulong)k[len_x + 0]);
							break;
